...
export default function ProformasClient({
  ...
  const filteredProformas = proformas.filter((p) => {
    ...
    const matchesStatus = statusFilter === 'todos' || p.estado.toLowerCase() === statusFilter.toLowerCase()
  ...
  const getStatusPillClass = (estado: string) => {
    switch (estado) {
      ...
      case 'fusionada': return 'bg-gray-500/20 text-gray-400 border border-gray-500/30'
      default:
